...
CREATE TABLE REZEPT (
    ...
    Ernaehrungskategorien   VARCHAR(50),
    Unvertraeglichkeiten    VARCHAR(50)
);
...
ALTER TABLE REZEPTBESTELLUNG ADD PRIMARY KEY (REZEPTNR,BESTELLNR);
...
ALTER TABLE REZEPTBESTELLUNG ADD FOREIGN KEY (BESTELLNR) REFERENCES BESTELLUNG (BESTELLNR);
ALTER TABLE REZEPTBESTELLUNG ADD FOREIGN KEY (REZEPTNR) REFERENCES REZEPT (REZEPTNR);